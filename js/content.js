    ...
    mutations.forEach((mutation) => {
        for(var i=0; i<mutation.addedNodes.length; i++) {
            ...
            if(mutation.target.classList.contains("playback-controls") && !foundFlag) {
                ...
                downloadButton.classList.add("playback-controls__button", "button", "has-tooltip");
                downloadIcon.classList.add("playback-controls__button", "button", "has-tooltip");
                ...
                mutation.target.insertBefore(downloadIcon, fs);
